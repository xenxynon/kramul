...
function clone() {
    # Clone Toolchain
		...
		git clone --depth=1 https://gitlab.com/xenxynon/azure-clang.git clang
...
function post_msg() {
    curl -s -X POST "https://api.telegram.org/bot$token/sendMessage" \
        -d chat_id="$chat_id" \
        -d sticker="CAACAgUAAxkBAAEEY19iTSpIgrbBsFleqpogLjvmLxR8EgACuAMAAlgiCVVYcVabvTjYQyME" \
